...
<section id="funders">
    ...
    <div class="funders-intro-banner">
        ...
        <div class="funders-cta-wrap">
            <a href="https://t.me/+d7riC1CS1eowZGFl" target="_blank" class="funder-pledge-btn hover-target">⭐ BECOME A FUNDER</a>
            <span class="funder-stars-note">join the channel · see payment details</span>
        </div>
    </div>
