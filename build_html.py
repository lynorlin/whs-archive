...
<audio id="bg-audio" loop src="https://upload.wikimedia.org/wikipedia/commons/b/b3/Chopin_-_Nocturne_Op_9_No_2_E_Flat_Major.ogg" crossorigin="anonymous"></audio>
        ...
        btn.addEventListener('click', () => {{
            ...
            cards.forEach(card => {{
                if(filter === 'all' || card.getAttribute('data-filter') === filter) {{
                    ...
                    anime({{ targets: card, scale: [0.9, 1], opacity: [0, 1], duration: 400, easing: 'easeOutQuad' }});
                }} else {{
